"""
Django settings for tabroom_zoom project.
...
INSTALLED_APPS = [
    'zoom_converter.apps.ZoomConverterConfig',
...
ROOT_URLCONF = 'tabroom_zoom.urls'
...
WSGI_APPLICATION = 'tabroom_zoom.wsgi.application'
